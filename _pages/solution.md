...
<details class="detail-group">
  <summary>
    ...
    <span class="detail-blurb">SOTA work in large language models, computer vision, and deep reinforcement learning — where the tools are still being invented.</span>
  </summary>
...
<details class="detail-group">
  <summary>
    ...
    <span class="detail-blurb">Pure math and theoretic coursework — the stuff I take to find out where the ceiling actually is.</span>
  </summary>
  <div class="detail-body">
...
<details class="detail-group">
  <summary>
    ...
    <span class="detail-blurb">Games and worlds I've built — interactive stories rather than shipped products.</span>
  </summary>
  <div class="detail-body">
    {% for p in cv.portfolio %}
      {% assign sub = p.topicCategory[1] %}
